			...
			<table> 
				...
				<tbody>
					<tr v-for="project in projects">
						...
						<td><a class="waves-effect waves-light btn green darken-4" href="#viewProject" v-on:click="getProject(project)">Ver</a></td>
					</td>
				</tr>
			</tbody>
		</table>
		<div id="viewProject" class="modal modal-fixed-footer" >
			<div class="viewPro">
				<div class="row">
	...
	module.exports = {
		...
		methods: {
			getProjects: function(){
				...
				this.$http.get(config.baseUrl() + '/v1/organization/'+this.organizationId+'/projects/').then(function(response){
			...
			getProject: function(project){
				...
				this.$http.get(config.baseUrl() + '/v1/organization/'+this.$route.params.organizationId+'/project/'+project.projectId).then(function(response){

            ...
            <table> 
                <thead>
                    <tr>
                        ...
                        <td data-field="action">Acción</td>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="project in projects">
                        ...
                        <td><a class="waves-effect waves-light btn red darken-4" v-on:click="removeProject(index)"><i class="material-icons">delete</i></a></td>
                    </tr>
                </tbody>
            </table>
        </div>
                ...
                <form class="col s12">
                    ...
                    <div class="row">
                        <div class="input-field col s2">
                            <input disabled value id="projectNumber" type="text" class="validate" v-model="project.projectNumber">
